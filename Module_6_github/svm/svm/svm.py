...
class SVMTrainer(object):
    ...
    def _create_predictor(self, X, y, lagrange_multipliers):
        """
            ...
            return   : Return SVMPredictor object
        """
    ...
    def _compute_lagrange_multipliers(self, X, y):
        ...
        P = cvxopt.matrix(np.outer(y, y) * K)  # Multiplies to y, outer перемножує усі елементи (усі комбінації)
        ...
        return np.ravel(solution['x'])  # Все, що n-вимірне, зводиться до вектору
